...
{
    [TestClass]
    public class PaymentAPIControllerUnitTest
    {
        [TestMethod]
        public void GetTest()
        {
            ...
            var controller = new PaymentsAPIController(DbContext);
            var getresult = controller.GetPayments().Result.Value;

            Assert.IsInstanceOfType(getresult, typeof(IEnumerable<Payment>));
